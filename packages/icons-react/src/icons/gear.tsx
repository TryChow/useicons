...
// Source: data/icons/{outline,filled}/gear.svg
...
export type GearIconProps = ZagIconProps & {
 ...
 */
export const AnimatedGearIcon = forwardRef<AnimatedIconHandle, AnimatedGearIconProps>(
  function AnimatedGearIcon(props, ref) {
    const {
      weight = 'outline',
      size = 24,
      color = 'currentColor',
  ...
  function GearIcon(props, ref) {
    ...
    if (animated) {
      return (
        <AnimatedGearIcon
          weight={weight}
          {...(rest as unknown as AnimatedGearIconProps)}
        />
      );
    }
