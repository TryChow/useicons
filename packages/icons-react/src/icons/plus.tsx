...
// Source: data/icons/{outline,filled}/plus.svg
...
export type PlusIconProps = ZagIconProps & {
...
export type AnimatedPlusIconProps = ZagAnimatedIconProps;

const PLUS_ANIMATION_VARIANTS = getIconAnimationVariants('plus');

const PLUS_GLYPHS: Record<IconWeight, ReactElement> = {
  outline: (
    <>
      <path fill="none" d="M224 128a8 8 0 0 1-8 8h-80v80a8 8 0 0 1-16 0v-80H40a8 8 0 0 1 0-16h80V40a8 8 0 0 1 16 0v80h80a8 8 0 0 1 8 8" />
    </>
  ),
  filled: (
    <>
 ...
 */
export const AnimatedPlusIcon = forwardRef<AnimatedIconHandle, AnimatedPlusIconProps>(
  function AnimatedPlusIcon(props, ref) {
    const {
      weight = 'outline',
      size = 24,
      color = 'currentColor',
  ...
  function PlusIcon(props, ref) {
    ...
    if (animated) {
      return (
        <AnimatedPlusIcon
          weight={weight}
          {...(rest as unknown as AnimatedPlusIconProps)}
        />
      );
    }
